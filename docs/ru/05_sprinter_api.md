...
- `dss_setwin(win, page)` подключает RAM-страницу к окну `0..3`.
- `dss_getmem()` выделяет одну страницу RAM и возвращает её номер, либо `0xFF`, если свободных страниц нет.
