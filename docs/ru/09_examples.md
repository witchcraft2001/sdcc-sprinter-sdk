...
Ожидаемый вывод: чёрный графический экран с четырьмя небольшими X/cross-спрайтами. После первого нажатия клавиши правый временный спрайт восстанавливается из теневой страницы; после второго нажатия пример возвращается в текстовый режим.
