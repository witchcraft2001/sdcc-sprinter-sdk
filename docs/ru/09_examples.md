...
SDK включает 15 готовых примеров, демонстрирующих различные возможности -- от простейшего "Hello World" до запуска дочерних программ через EXEC с разбором ошибок.
...
```bash
mkdir examples/16_myapp
```

### 2. Создайте исходный файл

Файл `examples/16_myapp/main.c`:
...
Файл `examples/16_myapp/Makefile`:
