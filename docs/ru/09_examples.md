...
SDK включает 24 готовых примера, демонстрирующих различные возможности -- от простейшего "Hello World" до графики, запуска дочерних программ через EXEC, работы с APPINFO, ENVIRON и косвенных вызовов.
