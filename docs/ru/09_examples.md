...
SDK включает 19 готовых примеров, демонстрирующих различные возможности -- от простейшего "Hello World" до запуска дочерних программ через EXEC, работы с APPINFO, ENVIRON и косвенных вызовов.
