; =========================================================================
;  crt0_page2.s - SDCC C runtime with DSS-allocated WIN2 stack page
; =========================================================================
;  Use with EXE header SP in WIN1 below PSP, typically:
;    CODE_LOC = 0x4200
;    STACK    = 0x40FF
;
...
;  allocates one DSS page, maps it to WIN2 and moves the working stack to
...
_entry::
        ...
        ; dss_exit() switches back here before DSS frees process pages.
        ld      hl, #0
        add     hl, sp
        ld      (_dss_exit_safe_sp), hl

        ; Allocate a 16K process page for WIN2 and the working stack.
        ld      b, #1
