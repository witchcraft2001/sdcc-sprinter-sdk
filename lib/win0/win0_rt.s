...
;  Linked into _WINRT at 0x8000 (WIN2, never repaged). Page-table vars in
;  _DATA (WIN2). See examples/win0.mk for the layout origins.
;
...
;
;  ABI note: these routines take NO C arguments (they are reached via RST/INT),
;  so they are identical under the SDCC 2.9.0 and 4.5.0 calling conventions.
; =========================================================================
